...
try:
   ...
   if b'>' in response:
       ...
       with open('/Users/rosia/Desktop/dcloud/configbackup/SDA/Sharedservices.txt', 'r') as f:
           data = f.readlines()
           for line in data:
...
try:
   ...
   if b'>' in response:
       ...
       with open('/Users/rosia/Desktop/dcloud/configbackup/SDA/Fusion.txt', 'r') as f:
           data = f.readlines()
           for line in data:
               print(line.encode('UTF-8'))
               s.send(line.encode('UTF-8'))
...
try:
   ...
   if b'>' in response:
       ...
       with open('/Users/rosia/Desktop/dcloud/configbackup/SDA/Core.txt', 'r') as f:
           data = f.readlines()
           for line in data:
               print(line.encode('UTF-8'))
               s.send(line.encode('UTF-8'))
...
try:
   ...
   if b'>' in response:
       ...
       with open('/Users/rosia/Desktop/dcloud/configbackup/SDA/Edge1.txt', 'r') as f:
           data = f.readlines()
           for line in data:
               print(line.encode('UTF-8'))
               s.send(line.encode('UTF-8'))
...
try:
   ...
   if b'>' in response:
       ...
       with open('/Users/rosia/Desktop/dcloud/configbackup/SDA/Edge2.txt', 'r') as f:
           data = f.readlines()
           for line in data:
               print(line.encode('UTF-8'))
               s.send(line.encode('UTF-8'))
